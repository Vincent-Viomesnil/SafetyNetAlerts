...
public class UrlsDAOTest {
    ...
    public void getPersonsListByStationNumberTest(){
        ...
        assertThat(urlsDAO.getPersonsListsFromStationNumber("3").getPersonsByStationNumbers().contains(person));
    }
    ...
    public void getPhoneNumberListByFirestationNumberTest() {
        ...
        assertThat(urlsDAO.getPhoneNumberListByFirestationNumber("3").getPhoneAlertList().toString().contains("06123456789"));
    }
